...
public class RegionDaoImpl implements RegionDao {
	...
	@Override
	public List<Region> listByProvinceIdLevel(String provinceName,Integer level) {
		RegionExample example = new RegionExample();
		example.createCriteria().andProvinceNameEqualTo(provinceName).andLevelEqualTo(level);
		return this.regionMapper.selectByExample(example);
	}

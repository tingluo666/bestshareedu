...
public class ApiRegionController extends BaseController {
	 ...
	 * 区域列出接口
	 */
	@ApiOperation(value = "区域列出接口", notes = "根据provinceName获取区域列表信息")
	...
	@RequestMapping(value = "/list/province/level", method = RequestMethod.POST)
	public Result<RegionListDTO> listForProvinceLevel(@RequestBody UserRegionProvinceBO userRegionProvinceBO) {
		return biz.listForProvinceLevel(userRegionProvinceBO);
	}
	/**
	 * 区域列出接口
	 */
